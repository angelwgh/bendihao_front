 ...
 *
 */
define (['const/global-constants', 'webuploader.flashonly', 'cropper', 'angular'],
	function (constant_, WebUploader) {
		...
		return ['$timeout', 'hbBasicData', function ($timeout, hbBasicData) {
			return {
				scope: {
					result: '=result',
					closeVar: '=close'
				...
				link: function (scope, element, attrs, ngModel) {
					...
					angular.element ('head').append ('<link href="../bower_components/webuploader_fex/dist/webuploader.css" rel="stylesheet">');
